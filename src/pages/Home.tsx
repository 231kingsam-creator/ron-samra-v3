...
══════════════════════════════════════════════════════════════ */
const treatments = [
  { num: '01', title: 'כאב שלא עובר?',               desc: 'כאבי גב, צוואר, ראש ומפרקים — גם אחרי פיזיותרפיה ותרופות. הרפואה הסינית מטפלת בשורש הבעיה, לא רק בסימפטום.',      href: 'articles.html', image: '/images/topics/back-pain.jpg' },
...
const articlePreviews = [
  ...
  },
  {
    ...
    title: 'בעיות שינה',
    desc: 'מתח כרוני, חרדה והפרעות שינה — כיצד רפואה סינית מחזירה את האיזון למערכת העצבים. הטיפול מותאם אישית לכל מטופל — על פי תסמיניו הספציפיים, אורח חייו ומצבו הרגשי. התוצאה: שינה עמוקה ומשקמת יותר, ללא תלות בתרופות. רון סמרה מתאים את הטיפול אישית לכל מטופל.',
